...
class LoginScreenState extends State<LoginScreen>
    ...
    if (_formKey.currentState != null && _formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (e.code == 'email-already-in-use') {
          ...
          // Fiberchat.toast("User not registered ");
          //This error may not occur since password append with 5 * when less than 6
        }
        //  print('Error: ' + e.code);
      }
  ...
  register() async {
    final email = _usernameController.text + '@okidokinow.com';
    try {
      final credential =
                          ...
                          child: TextFormField(
                            ...
                            validator: (v) {
                              ...
                              /* else if( v != null && v.length >7 ){
                                return 'Password should contain atleast 6 digit';
                              }*/
