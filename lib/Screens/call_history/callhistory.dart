...
import 'package:fiberchat/Screens/jitsi/JitsiCall.dart';
            ...
            ? Padding(
                ...
                child: FloatingActionButton(
                    ...
                    onPressed: () {
                      ...
                      // call JITSI screen here
                      print("--- real user phone number ${widget.userphone}");

                      Navigator.push(
                          context,
                          new MaterialPageRoute(
                              builder: (context) => new JitsiCall(widget.userphone!)));
